...
public class LispLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"PRINT", "DEFPARAMETER", "LAMBDA", "FORMAT", "IDENTIFIER", "PLUS", "MINUS", 
			"MULT", "DIV", "MOD", "GREATER_EQUAL", "LESS_EQUAL", "GREATER", "LESS", 
			"EQUAL", "LPAREN", "RPAREN", "TRUE", "FALSE", "COMMENT", "WS", "ERROR"
		};
	}
